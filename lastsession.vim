...
setlocal statusline=%#lualine_a_command#\ COMMAND\ %#lualine_transitional_lualine_a_command_to_lualine_c_normal#%<%#lualine_c_normal#\ [No\ Name]\ [-]\ %#lualine_c_normal#%=%#lualine_c_normal#\ utf-8\ %#lualine_c_normal#\ \ %#lualine_x_filetype_DevIconDefault_command#\ %#lualine_c_normal#\ alpha\ %#lualine_transitional_lualine_b_command_to_lualine_c_normal#%#lualine_b_command#\ 57%%\ %#lualine_transitional_lualine_a_command_to_lualine_b_command#%#lualine_a_command#\ \ 16:56\ 
